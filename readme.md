...
- Navigate to `C:\Windows\System32\portfolio\src` and open the `landing.js` file to change your information. [Use https://icon-sets.iconify.design/skill-icons/ for changing the skill icons on the home page]
